window.MOCK_USERS = [
  {
    ...
    unit: "Phòng Kỹ thuật Hình sự",
    role: "admin",
    password: "admin123",
    lastLogin: "2026-04-24T08:30:00",
  },
  {
    id: "2",
    username: "tran.huu.duc",
    full_name: "Thiếu tá Trần Hữu Đức",
    unit: "Đội Điều tra Kinh tế",
    role: "user",
    password: "duc123",
    lastLogin: "2026-04-24T09:15:00",
  },
  {
    id: "3",
    username: "le.thi.mai",
    full_name: "Thượng úy Lê Thị Mai",
    unit: "Phòng Cảnh sát Hình sự",
    role: "user",
    password: "mai123",
    lastLogin: "2026-04-23T14:20:00",
  },
  {
    id: "4",
    username: "pham.quoc.hung",
    full_name: "Trung úy Phạm Quốc Hùng",
    unit: "Đội Điều tra Ma túy",
    role: "user",
    password: "hung123",
    lastLogin: "2026-04-23T16:45:00",
  },
  {
    id: "5",
    username: "nguyen.thi.lan",
    full_name: "Thiếu úy Nguyễn Thị Lan",
    unit: "Phòng Hồ sơ",
    role: "user",
    password: "lan123",
    lastLogin: "2026-04-22T10:00:00",
  },
  {
    id: "6",
    username: "vo.dinh.thanh",
    full_name: "Trung tá Võ Đình Thành",
    unit: "Đội Điều tra Tham nhũng",
    role: "user",
    password: "thanh123",
    lastLogin: "2026-04-24T07:50:00",
  },
  {
    id: "7",
    username: "hoang.van.minh",
    full_name: "Thiếu tá Hoàng Văn Minh",
    unit: "Phòng Kỹ thuật Hình sự",
    role: "user",
    password: "minh123",
    lastLogin: "2026-04-21T13:30:00",
  },
  {
    id: "8",
    username: "bui.thi.huong",
    full_name: "Đại úy Bùi Thị Hương",
    unit: "Đội Điều tra Kinh tế",
    role: "user",
    password: "huong123",
    lastLogin: "2026-04-20T09:00:00",
  },
];
...
window.MOCK_DOCUMENTS = [
  {
    ...
    summary:
      "Quy định trình tự, thủ tục tiếp nhận, giải quyết tố giác, tin báo về tội phạm, kiến nghị khởi tố; khởi tố, điều tra, truy tố, xét xử và thi hành án hình sự.",
          ...
          articles: [
            {
              ...
              text: "Mọi hoạt động tố tụng hình sự phải được thực hiện theo quy định của Bộ luật này. Không được giải quyết nguồn tin về tội phạm, khởi tố, điều tra, truy tố, xét xử ngoài những căn cứ và trình tự, thủ tục do Bộ luật này quy định.",
            },
            {
              id: "art6",
              title:
                "Điều 8. Tôn trọng và bảo vệ quyền con người, quyền và lợi ích hợp pháp của cá nhân",
              text: "Khi tiến hành tố tụng hình sự, trong phạm vi nhiệm vụ, quyền hạn của mình, cơ quan, người có thẩm quyền tiến hành tố tụng phải tôn trọng và bảo vệ quyền con người, bảo đảm lợi ích hợp pháp của mọi cá nhân tham gia hoặc có liên quan đến hoạt động tố tụng hình sự, nghiêm cấm mọi hành vi xâm phạm trái pháp luật đến tính mạng, sức khỏe, danh dự, nhân phẩm, tài sản và các quyền và lợi ích hợp pháp khác của họ.",
            },
            {
              id: "art7",
              title: "Điều 9. Bảo đảm quyền bình đẳng trước pháp luật",
              text: "Tố tụng hình sự được tiến hành theo nguyên tắc mọi người đều bình đẳng trước pháp luật, không phân biệt dân tộc, giới tính, tín ngưỡng, tôn giáo, thành phần và địa vị xã hội. Bất cứ người nào phạm tội đều bị xử lý theo pháp luật. Bất cứ tổ chức, cá nhân nào xâm phạm quyền và lợi ích hợp pháp của cơ quan, tổ chức, cá nhân đều phải bị xử lý theo pháp luật.",
            },
            {
              id: "art8",
              title: "Điều 13. Suy đoán vô tội",
              text: "Người bị buộc tội được coi là không có tội cho đến khi được chứng minh theo trình tự, thủ tục do Bộ luật này quy định và có bản án kết tội của Tòa án đã có hiệu lực pháp luật. Khi không đủ và không thể làm sáng tỏ căn cứ để buộc tội, kết tội theo trình tự, thủ tục do Bộ luật này quy định thì cơ quan, người có thẩm quyền tiến hành tố tụng phải kết luận người bị buộc tội không có tội.",
            },
          ],
        },
        {
      ...
      chapters: [
        {
          ...
          articles: [
            {
              id: "art1",
              title: "Điều 1. Nhiệm vụ của Bộ luật Hình sự",
              text: "Bộ luật Hình sự có nhiệm vụ bảo vệ chủ quyền quốc gia, an ninh của đất nước, bảo vệ chế độ xã hội chủ nghĩa, quyền con người, quyền công dân, bảo vệ quyền bình đẳng giữa đồng bào các dân tộc, bảo vệ lợi ích của Nhà nước, tổ chức, bảo vệ trật tự pháp luật, chống mọi hành vi phạm tội; giáo dục mọi người ý thức tuân theo pháp luật, phòng ngừa và đấu tranh chống tội phạm.",
            },
            {
              id: "art2",
              title: "Điều 2. Cơ sở của trách nhiệm hình sự",
              text: "Chỉ người nào phạm một tội đã được Bộ luật Hình sự quy định mới phải chịu trách nhiệm hình sự. Chỉ pháp nhân thương mại nào phạm một tội đã được quy định tại Điều 76 của Bộ luật này mới phải chịu trách nhiệm hình sự.",
            },
            {
              id: "art3",
              title: "Điều 8. Khái niệm tội phạm",
  ...
  },
  {
    ...
    category: "nghiep-vu",
    categoryLabel: "Nghiệp vụ Điều tra",
    summary:
          ...
          articles: [
            {
              id: "art1",
              title: "Điều 1. Phạm vi điều chỉnh",
              text: "Thông tư này quy định về trình tự, thủ tục thu thập, bảo quản, vận chuyển, xử lý vật chứng trong điều tra, truy tố, xét xử vụ án hình sự của Cơ quan điều tra trong Công an nhân dân.",
            },
            {
              id: "art2",
              title: "Điều 2. Nguyên tắc thu thập vật chứng",
              text: "Việc thu thập vật chứng phải tuân theo các nguyên tắc sau:\n1. Đúng quy trình, thủ tục pháp luật quy định.\n2. Kịp thời, đầy đủ, không bỏ sót.\n3. Bảo đảm tính nguyên vẹn, không làm thay đổi đặc tính của vật chứng.\n4. Lập biên bản thu giữ vật chứng đầy đủ, chính xác.\n5. Giao nhận vật chứng có chữ ký của các bên liên quan.",
            },
          ],
        },
        {
  ...
  },
  {
    ...
    category: "tham-nhung",
    categoryLabel: "Phòng chống tham nhũng",
    summary:
...
window.MOCK_LOGS = [
  {
    ...
    created_at: "2026-04-24T09:15:22",
  },
  {
    id: "log-002",
    user_id: "2",
    ...
    full_name: "Thiếu tá Trần Hữu Đức",
    action: "SEARCH",
    details: "tội giết người điều 123",
    created_at: "2026-04-24T09:16:45",
  },
  {
    id: "log-003",
    user_id: "2",
    ...
    action: "VIEW_DOC",
    details: "doc-002",
    created_at: "2026-04-24T09:17:30",
  },
  {
    id: "log-004",
    user_id: "3",
    ...
    action: "LOGIN",
    details: "Đăng nhập thành công",
    created_at: "2026-04-23T14:20:10",
  },
  {
    id: "log-005",
    user_id: "3",
    ...
    full_name: "Thượng úy Lê Thị Mai",
    action: "SEARCH",
    details: "thu thập vật chứng hiện trường",
    created_at: "2026-04-23T14:22:00",
  },
  {
    id: "log-006",
    user_id: "3",
    ...
    action: "VIEW_DOC",
    details: "doc-003",
    created_at: "2026-04-23T14:23:15",
  },
  {
    id: "log-007",
    user_id: "4",
    ...
    action: "LOGIN",
    details: "Đăng nhập thành công",
    created_at: "2026-04-23T16:45:00",
  },
  {
    id: "log-008",
    user_id: "4",
    ...
    full_name: "Trung úy Phạm Quốc Hùng",
    action: "SEARCH",
    details: "ma tuy methamphetamine",
    created_at: "2026-04-23T16:46:30",
  },
  {
    id: "log-009",
    user_id: "4",
    ...
    action: "VIEW_DOC",
    details: "doc-002",
    created_at: "2026-04-23T16:48:00",
  },
  {
    id: "log-010",
    user_id: "6",
    ...
    action: "LOGIN",
    details: "Đăng nhập thành công",
    created_at: "2026-04-24T07:50:00",
  },
  {
    id: "log-011",
    user_id: "6",
    ...
    full_name: "Trung tá Võ Đình Thành",
    action: "SEARCH",
    details: "tham nhũng nhận hối lộ",
    created_at: "2026-04-24T07:52:15",
  },
  {
    id: "log-012",
    user_id: "6",
    ...
    action: "VIEW_DOC",
    details: "doc-004",
    created_at: "2026-04-24T07:54:00",
  },
  {
    id: "log-013",
    user_id: "1",
  ...
  },
  {
    ...
    full_name: "Thiếu úy Nguyễn Thị Lan",
    action: "SEARCH",
    details: "quy trinh hoi cung bi can",
  ...
  },
  {
    ...
    action: "VIEW_DOC",
    details: "doc-005",
    created_at: "2026-04-22T10:07:30",
  },
  {
    id: "log-017",
    user_id: "7",
  ...
  },
  {
    ...
    full_name: "Thiếu tá Hoàng Văn Minh",
    action: "SEARCH",
    details: "to tung hinh su khoi to",
    created_at: "2026-04-21T13:32:00",
  },
  {
    id: "log-019",
    user_id: "7",
    ...
    action: "VIEW_DOC",
    details: "doc-001",
    created_at: "2026-04-21T13:35:00",
  },
  {
    id: "log-020",
    user_id: "8",
...
window.fuzzyMatch = function (text, query) {
  ...
  const normalText = window.removeVietnameseDiacritics(text);
  const normalQuery = window.removeVietnameseDiacritics(query.trim());
  return (
    normalText.includes(normalQuery) ||
