    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#f8fafc] relative">
      <div className="w-full max-w-[420px] relative">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-forest text-xl font-bold m-0 tracking-wide uppercase">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-xl shadow-slate-200/50">
          <h2 className="text-slate-800 text-lg font-bold m-0 mb-6 text-center">
            Đăng nhập hệ thống
          </h2>

          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-slate-500 text-[12px] mb-1.5 font-bold uppercase tracking-wider">
                Tên đăng nhập
              </label>
          ...
          <div className="mt-6 p-4 bg-slate-50 rounded-xl border border-slate-100">
            <p className="text-slate-500 text-[11px] m-0 text-center leading-relaxed font-bold uppercase tracking-widest">
              Hệ thống lưu hành nội bộ
            </p>
          </div>
        </div>
